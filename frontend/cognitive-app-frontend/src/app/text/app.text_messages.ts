...
export const TEXTS = {
    menu: {
        ...
        cognitive_profile_edit: 'Kognitív profil szerkesztése',
        profile_comparison: 'Kapcsolatok kognitív profil elemzése',
        own_profile_comparison: 'Kognitív profil elemzés',
