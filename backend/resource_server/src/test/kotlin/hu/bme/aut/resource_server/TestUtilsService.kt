...
class TestUtilsService(
    ...
    fun createUnsavedTestUser(): UserEntity{
        val profile  = mutableSetOf(
                FloatProfileItem(
                        abilityEntity = abilityGf,
                        abilityValue = 10.0
                ),
                FloatProfileItem(
                        abilityEntity = abilityGq,
                        abilityValue = 4.0
                ),
        )
        return UserEntity(
    ...
    fun createAndSaveGame(): GameEntity{
        ...
        val game = GameEntity(
            name = "Test game",
            icon= "test",
            thumbnailPath = Paths.get("src", "test", "kotlin/hu/bme/aut/resource_server", "game", "resources", "test_game_icon.png").toString(),
